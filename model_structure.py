...
def unet2D(images, training, nlabels):
    ...
    concat4 = tf.crop_and_concat_layer([conv4_2, upconv4], axis=3, name='concat4')
    ...
    concat3 = tf.crop_and_concat_layer([conv3_2, upconv3], axis=3, name='concat3')
    ...
    concat2 = tf.crop_and_concat_layer([conv2_2, upconv2], axis=3, name='concat2')
    ...
    concat1 = tf.crop_and_concat_layer([conv1_2, upconv1], axis=3, name='concat1')
