...
def run_training(continue_run):
 ...
 #       logging.info(images_train.shape[0])
    ...
    with tf.Graph().as_default():
        ...
        if (config.experiment_name == 'unet2D_valid' or config.experiment_name == 'unet2D_same' or 
            config.experiment_name == 'unet2D_same_mod' or config.experiment_name == 'unet2D_light' or
            config.experiment_name == 'Dunet2D_valid'):
